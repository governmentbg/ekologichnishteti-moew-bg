...
namespace Zopoesht.Persistence.Migrations
{
    ...
    [Migration("20240726102506_app-one-authority")]
    partial class apponeauthority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zopoesht.Data.Applications.ApplicationOne.ApplicationOneAuthority", b =>
                {
                    ...
                    b.Property<bool>("StartedCurrentApplicationOne")
                        .HasColumnType("boolean")
                        .HasColumnName("startedcurrentapplicationone");
            ...
            modelBuilder.Entity("Zopoesht.Data.Applications.ApplicationOne.ApplicationOneBasic", b =>
                {
                    ...
                    b.Property<string>("CountryAuthority")
                        .HasColumnType("text")
                        .HasColumnName("countryauthority");
            ...
            modelBuilder.Entity("Zopoesht.Data.Applications.ApplicationTwo.ApplicationTwo", b =>
                {
                    ...
                    b.Property<DateTime?>("DamageConfirmedDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("damageconfirmeddate");

                    b.Property<DateTime?>("DamageOccurrenceDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("damageoccurrencedate");
                    ...
                    b.Property<bool>("HasSoilDamageDamage")
                        .HasColumnType("boolean")
                        .HasColumnName("hassoildamagedamage");

                    b.Property<bool>("HasSoilDamageThreat")
                        .HasColumnType("boolean")
                        .HasColumnName("hassoildamagethreat");

                    b.Property<bool>("HasSpeciesDamageDamage")
                        .HasColumnType("boolean")
                        .HasColumnName("hasspeciesdamagedamage");

                    b.Property<bool>("HasSpeciesDamageThreat")
                        .HasColumnType("boolean")
                        .HasColumnName("hasspeciesdamagethreat");

                    b.Property<bool>("HasUnreimbursedExpense")
                        .HasColumnType("boolean")
                        .HasColumnName("hasunreimbursedexpense");

                    b.Property<bool>("HasWaterDamageDamage")
                        .HasColumnType("boolean")
                        .HasColumnName("haswaterdamagedamage");

                    b.Property<bool>("HasWaterDamageThreat")
                        .HasColumnType("boolean")
                        .HasColumnName("haswaterdamagethreat");
                    ...
                    b.Property<DateTime?>("ThreatConfirmedDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("threatconfirmeddate");

                    b.Property<DateTime?>("ThreatOccurrenceDate")
                        .HasColumnType("timestamp without time zone")
                        .HasColumnName("threatoccurrencedate");
            ...
            modelBuilder.Entity("Zopoesht.Data.Applications.ApplicationTwo.ApplicationTwoSubActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("applicationtwosubactivity");
                });
            ...
            modelBuilder.Entity("Zopoesht.Data.Nomenclatures.AdministrativeUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("AdministrativeUnitType")
                        .HasColumnType("integer")
                        .HasColumnName("administrativeunittype");
            ...
            modelBuilder.Entity("Zopoesht.Data.Nomenclatures.Operators.Operator", b =>
                {
                    ...
                    b.Property<int>("AdministrativeUnitBasinId")
                        .HasColumnType("integer")
                        .HasColumnName("administrativeunitbasinid");

                    b.Property<int>("AdministrativeUnitRiosvId")
                        .HasColumnType("integer")
                        .HasColumnName("administrativeunitriosvid");
                    ...
                    b.HasIndex("AdministrativeUnitBasinId");

                    b.HasIndex("AdministrativeUnitRiosvId");
            ...
            modelBuilder.Entity("Zopoesht.Data.Applications.ApplicationTwo.ApplicationTwoSubActivity", b =>
                {
                    b.HasOne("Zopoesht.Data.Applications.ApplicationTwo.ApplicationTwo", "ApplicationTwo")
                        .WithMany("ApplicationTwoSubActivities")
                        .HasForeignKey("ApplicationTwoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Zopoesht.Data.Nomenclatures.Operators.Operator", b =>
                {
                    b.HasOne("Zopoesht.Data.Nomenclatures.AdministrativeUnit", "AdministrativeUnitBasin")
                        .WithMany()
                        .HasForeignKey("AdministrativeUnitBasinId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Zopoesht.Data.Nomenclatures.AdministrativeUnit", "AdministrativeUnitRiosv")
                        .WithMany()
                        .HasForeignKey("AdministrativeUnitRiosvId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("AdministrativeUnitBasin");

                    b.Navigation("AdministrativeUnitRiosv");
            ...
            modelBuilder.Entity("Zopoesht.Data.Nomenclatures.Operators.Terrain", b =>
                {
                    ...
                    b.HasOne("Zopoesht.Data.Nomenclatures.Operators.Operator", null)
                        .WithMany("Terrains")
                        .HasForeignKey("OperatorId");
            ...
            modelBuilder.Entity("Zopoesht.Data.Applications.ApplicationTwo.ApplicationTwo", b =>
                {
                    ...
                    b.Navigation("ApplicationTwoSubActivities");

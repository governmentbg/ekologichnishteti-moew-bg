...
export class ActTypeComponent extends BaseNomenclatureComponent<ActType, BaseNomenclatureFilterDto> implements OnInit {
  ngOnInit(): void {
    this.init(ActType, BaseNomenclatureFilterDto, 'ActType');
  }
}